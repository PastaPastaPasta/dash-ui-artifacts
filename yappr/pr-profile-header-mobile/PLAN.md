...
|---|---|---|---|---|
| Own edit, 320px | 733faf53cd893cba861476a4af75b442ed67ca72 | committed fix/profile-header-mobile-actions, full hash recorded before capture | persona 55, Rosa Yamamoto; light theme, Chromium,320x844 | Save fits within viewport beside avatar, wrapped action rows |
| Other profile,320px | same | same | viewer55, profile57; no writes | Header controls wrap within available width |
| Own read/edit/cancel,390/1280px | same | same | same persona 55, unchanged profile | Compatibility measurements; screenshot if materially different |
