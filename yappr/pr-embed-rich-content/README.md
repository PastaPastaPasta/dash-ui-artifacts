...
|Desktop, divider before inline image: saved video | ![](before/video-1280.png) | ![](after/video-1280.png) |
...
Validation:10renderer regression cases, with8failing the exact base and all10passing head;21total embed tests; targeted lint, full TypeScript, and committed production devnet build. The original six PNGs were inspected at original resolution. Actual browser checks confirm saved `const qa = "persisted";`, first `QA table cell` and last `Last cell`, and correct video destination. The320px document stays320px wide.
