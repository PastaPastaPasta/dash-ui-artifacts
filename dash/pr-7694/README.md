...
Before: `f5979f7c56da7bee6ce9bb0b7b21fd2c3d745b61`. After: `e5349ca62e5dcbd592870910cf2c73a83749ada8`.
...
Updated after the node-model-detachment guard: after images were recaptured from the final head above. Programmatic model detachment with the voting dialog open was also verified to disable voting and send no vote when the dialog is accepted. The earlier evidence commit is superseded by this index.
